...
def inter_dataset():
    ...
    for dataset_train in dataset_names:
        for dataset_test in dataset_names:
                ...
                recalls = []
                for i in range(10):
                    clf=LogisticRegression(max_iter=1000,n_jobs=cpu_count())
...
make_plots("DoS", "logistic", "contaminants")
...
make_plots("DoS", "logistic", "generalization contaminants")
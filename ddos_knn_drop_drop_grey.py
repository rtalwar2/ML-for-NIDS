...
for k,v in datasets.items():
    ...
    ['SHORTEST_FLOW_PKT', 'TCP_FLAGS', 'CLIENT_TCP_FLAGS', 'DST_TO_SRC_SECOND_BYTES', 'OUT_BYTES', 'OUT_PKTS', 'RETRANSMITTED_OUT_BYTES', 'RETRANSMITTED_OUT_PKTS', 'NUM_PKTS_1024_TO_1514_BYTES', 'DST_TO_SRC_AVG_THROUGHPUT', 'NUM_PKTS_UP_TO_128_BYTES', 'IN_PKTS', 'LONGEST_FLOW_PKT', 'SRC_TO_DST_SECOND_BYTES', 'IN_BYTES', 'RETRANSMITTED_IN_BYTES', 'RETRANSMITTED_IN_PKTS', 'SRC_TO_DST_AVG_THROUGHPUT', 'ICMP_TYPE', 'ICMP_IPV4_TYPE', 'L7_PROTO', 'PROTOCOL', 'DURATION_OUT', 'NUM_PKTS_128_TO_256_BYTES', 'NUM_PKTS_512_TO_1024_BYTES', 'NUM_PKTS_256_TO_512_BYTES']
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/accuracy_heatmap_ddos_knn_dropped.png")
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/precision_heatmap_ddos_knn_dropped.png")
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/recall_heatmap_ddos_knn_dropped.png")
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/accuracy_heatmap_ddos_knn_extra_dropped.png")
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/precision_heatmap_ddos_knn_extra_dropped.png")
...
ax.set_yticklabels(dataset_names, rotation=0, ha='right')
plt.subplots_adjust(left=0.2)
plt.savefig(f"/project_ghent/raman/images/recall_heatmap_ddos_knn_extra_dropped.png")

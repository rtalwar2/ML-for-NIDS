...
path = Path('/project_ghent/raman/cic-ids2017/flow_images/train')
...
#     im=im.resize((256,256))
    ...
    print(i)
print("started with 2017 train")
print(f"total :{df.shape[0]} images")
...
path = Path('/project_ghent/raman/cic-ids2017/flow_images/test')
